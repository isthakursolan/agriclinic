...
@section('content')
    <div class="app-content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h2 class="text-2xl font-bold mb-0">Add Sample Type</h2>
                </div>
                <div class="col-sm-6">
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header text-white" style="background-color: #777777;">
                    <h3 class="card-title mb-0 text-white"><i class="bi bi-clipboard-data me-2"></i>Add Sample Type</h3>
                </div>
                    <form action="{{ route('admin.sample-types.store') }}" method="POST">
                        @csrf
                        <div class="card-body">
