            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header text-white" style="background-color: #777777;">
                        <h3 class="card-title mb-0 text-white"><i class="bi bi-person-plus me-2"></i> Add Farmer</h3>
                    </div>
                    <form action="{{ route('farmer.store') }}" method="POST">
                        ...
                        <div class="card-body">
                            <div style="padding: 15px;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label fw-semibold">Password <span style="color: #777777;">*</span></label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="form-check mt-2">
                                                <input type="checkbox" name="contact_same_as_whatsapp" value="1" class="form-check-input" id="sameAsContact">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="qualification" value="{{ old('qualification', $profile->qualification ?? '') }}" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="district" value="{{ old('district', $profile->district ?? '') }}" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="pincode" value="{{ old('pincode', $profile->pincode ?? '') }}" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label fw-semibold">Post Office</label>
                                            <input type="text" name="postoffice" value="{{ old('postoffice', $profile->postoffice ?? '') }}" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="referred_by" value="{{ old('referred_by', $profile->referred_by ?? '') }}" class="form-control" placeholder="Who referred you to us?">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label fw-semibold">Farming Since</label>
                                            <input type="text" name="farming_since" value="{{ old('farming_since', $profile->farming_since ?? '') }}" class="form-control" placeholder="e.g., 2010">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label fw-semibold">Land Area Cultivated (acres)</label>
                                            <input type="text" name="land_area_cultivated" value="{{ old('land_area_cultivated', $profile->land_area_cultivated ?? '') }}" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label fw-semibold">Total Land Area (acres)</label>
                                            <input type="text" name="land_area_total" value="{{ old('land_area_total', $profile->land_area_total ?? '') }}" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label fw-semibold">Capital Investment</label>
                                            <input type="text" name="capital_investment" value="{{ old('capital_investment', $profile->capital_investment ?? '') }}" class="form-control" placeholder="e.g., ₹50,000">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                        ...
                        <div class="card-footer text-right">
                            <div style="padding: 15px;">
                                <button type="submit" class="btn btn-dark"><i class="fas fa-save"></i> Create Farmer</button>
