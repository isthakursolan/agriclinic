                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="farmer_id" name="farmer_id" class="form-control" required>
                                            ...
                                            @foreach ($profile as $p)
                                                <option value="{{ $p->profile->id }}"
                                                    data-fields="{{ json_encode($p->fields) }}"
                                                    data-crops="{{ json_encode($p->activeCrops) }}">
                                                    {{ $p->profile->fullname }} </option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select id="field_id" name="field_id" class="form-control" required>
